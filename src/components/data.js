const items = [
    {
      title: "2018 - current",
      cardTitle: "Outlaw Automation - System Integrator",
      cardSubtitle:
        "Calgary, Canada",
      cardDetailedText: `SCADA System Integration, ETL. Deployment and management of linux server, SQL databases. Python module development that extend system functionality. Frontend development, HMI with data visualization tools. Custom python reporting tools. Configuration of VPN secured mobile networks. 3D modeling / product design and print. 24/7 on-call rotation - product support`
    },
    {
      title: "25 July 1940",
